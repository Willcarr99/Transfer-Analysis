...
if fort == 201:
    ...
    control_data = 'control_202.txt'
    parameter_adjusted_data = 'fort.202'
...
if parameter_adjusted_data == 'fort.202':
    ax.set_ylabel(r'$d \sigma / d \Omega \, [mb/sr]$', size = 15)
elif parameter_adjusted_data == 'fort.201':
    ax.set_ylabel(r'$\frac{d \sigma}{d \Omega} / {\frac{d \sigma}{d \Omega}}_{Ruth}$', size = 15)
else:
    print('Error: fort.201 or fort.202 not selected')
ax.set_title(title + ' (fort.' + str(fort) + ')', size = 20)
ax.semilogy()
